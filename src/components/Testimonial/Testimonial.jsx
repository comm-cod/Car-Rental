...
const testimonialData = [
  {
    name: "Sar",
    image: '',
    description: 'Lorem ipsum dora shora lora hora',
    aosDelay: '0'
  },
  {
    name: "Satya",
    ...
    <div className='dark:bg-black dark:text-white py-14 sm:pb-24'>
      <div className="container">
        ...
        <div data-aos='fade-up'
          ...
          <p data-aos='fade-up' className='text-center sm:px-44 '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita dolorum</p>
        </div>
        {/* card section */}
